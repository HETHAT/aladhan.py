...
.. image:: https://img.shields.io/pypi/pyversions/aladhan.py?color=orange
    :target: https://pypi.python.org/pypi/aladhan.py
    :alt: Supported Python versions
.. image:: https://img.shields.io/github/checks-status/HETHAT/aladhan.py/main?label=tests
    :target: https://github.com/HETHAT/aladhan.py/actions/workflows/python-package.yml
